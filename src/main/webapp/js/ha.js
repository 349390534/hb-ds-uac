(function() {
    ...
    var _hat_ = "_hat"
      ...
      ,hbc="www.howbuy.com"
  	  ...
  	  ,rc_domain=".howbuy.com"
  	  ,uac_path="/uac/ha.do"//上报PV服务path配置
	  ,uac_uapath="/uac/uac.do"// 上报EVENT服务path配置
	  ,uac_clickpath="/uac/hbhc.do"//上报CLICK服务path配置
	  ,isUacTe=false//uac上报host是否是交易网站,默认否,根据情况修改
	  ;
    var COOKIE_USER_PERSISTENCE = 63072000000;//Two years in millseconds.
    var BrowserDetect = {
        init: function() {
    ...
    var GaAjax = function(config) {
        ...
        oThis.getHowbuyAnalyticsPath = function() {
        	return (window.location.protocol == "https:") ? "https://"+getUacHost()+uac_path : "http://"+getUacHost()+uac_path;
        }
        ;
    ...
    var HTracker = function(name, account, namespace) {
        ...
        oThis.AUP=function(){
        	return (window.location.protocol=="https:")?"https://"+getUacHost()+uac_uapath:"http://"+getUacHost()+uac_uapath;
        };
...
//                            e.href = a.substr(0, u) + "?HTAG=" + hTag + "#" + a.substr(u + 1)
    ...
    ;
    var ucp=function(){
    	var p = getUacHost()+uac_clickpath;
    	return (window.location.protocol=="https:")?"https://"+p:"http://"+p;
    };
    /**
     * 绑定body的mouseover事件
     */
